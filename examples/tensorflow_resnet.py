...
from tfws_v4.components.model.net.resnet import resnet
...
params = {
    ...
    "remark": "same to google cifar10",
    "deep_stem": True,
    "avg_down": True,
}


model = resnet(data, True, params)
...
if tf.executing_eagerly():
    ...
    with tf.Session(config=config) as session:
        ...
        # for x in range(args.num_iters):
        #     _, loss_val = session.run([train_opt, loss])
        #     if x % 10 == 0:
        #         log('ALoss: %f, Step: %d' % (loss_val, x))
